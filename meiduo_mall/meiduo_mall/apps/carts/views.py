...
class CartsView(View):
    ...
    def put(self, request):
        ...
        selected = json_dict.get('selected', default=True)
        # 校验参数
        ...
        if request.user.is_authenticated:
            ...
            response.set_cookie('carts', carts,max_age=3600*24*15)
            # 返回
            return response
    ...
    def post(self, request):
        ...
        if request.user.is_authenticated():
            ...
            if sku_id in cart_dict:
                count += cart_dict[int(sku_id)]['count']
            ...
            response.set_cookie('carts', carts_data,max_age=3600*24*15)
            # 返回
            return response
