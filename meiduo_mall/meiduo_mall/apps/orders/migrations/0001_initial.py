# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2019-06-02 08:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.SmallIntegerField(choices=[(0, '0分'), (1, '20分'), (2, '40分'), (3, '60分'), (4, '80分'), (5, '100分')], default=5, verbose_name='商品评分')),
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='skus', to='orders.OrderInfo', verbose_name='订单编号'),
        ),
        migrations.AddField(
            model_name='ordergoods',
            name='sku',
